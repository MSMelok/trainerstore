...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const trainerCards = document.querySelectorAll('.trainer__title');
    ...
    searchInput.addEventListener('input', function () {
        ...
        trainerCards.forEach(function (card) {
            ...
            if (title.includes(searchTerm)) {
                ...
                // Allow for slight variations in spelling or typing
...
document.addEventListener('DOMContentLoaded', function() {
    updateTrainerCounter();
});

function updateTrainerCounter() {
    const trainerCards = document.getElementsByClassName('trainer__card');
    const trainerCounter = document.getElementById('trainer-counter');
    trainerCounter.textContent = trainerCards.length;
}